...
namespace ETHotfix {
  ...
  #region Messages
  public partial class C2R_TestCall : pb::IMessage {
    private static readonly pb::MessageParser<C2R_TestCall> _parser = new pb::MessageParser<C2R_TestCall>(() => (C2R_TestCall)MessagePool.Instance.Fetch(typeof(C2R_TestCall)));
    public static pb::MessageParser<C2R_TestCall> Parser { get { return _parser; } }
  ...
  public partial class R2C_TestCall : pb::IMessage {
    private static readonly pb::MessageParser<R2C_TestCall> _parser = new pb::MessageParser<R2C_TestCall>(() => (R2C_TestCall)MessagePool.Instance.Fetch(typeof(R2C_TestCall)));
    public static pb::MessageParser<R2C_TestCall> Parser { get { return _parser; } }
